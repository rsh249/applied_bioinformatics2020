...
Generate a script to create all these graphs but for the death or recovery rate instead of the total cases. Run the script, save the graphs (using ggsave), and put the code and graphs in your blog. Spend some time in your blog reflecting on the data you see in these.